...
class AppointmentController {
  ...
  async delete(req, res) {
    ...
    /**
     * Verifica se o usuário que está logado está tentando cancelar
     * um agendamento de outro usuário
     */
    ...
    const dateWithSub = subHours(appointment.date, 2); // Remove 2h do horário do agendamento

    /**
     * Verifica se a hora tem a diferença de 2h para poder cancelar o agendamento
     * new Date() - data atual
     */
